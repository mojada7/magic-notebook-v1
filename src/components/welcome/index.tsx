...
function Welcom() {
  ...
  let addUser1 = (name : string, data : any) : void => {
    localStorage.setItem('magic_notebook', JSON.stringify({name: name, data : data}))
    setmode(1)
  }
  ...
  return (
    <>
        ...
        <div className={`${mode&&style.m2} ${mode?'-left-[250vw] lg:-left-[350vw]':'-left-[110vw] lg:-left-[40vw]'} hover:scale-105 absolute top-[10vh] lg:-top-[5vh] h-[110vh] lg:h-[150vh] w-[250vw] lg:w-[121vw] -left-[110vw] lg:-left-[40vw] z-50`}>
         <Image src={cloud} alt='' fill />
        </div>
        <div className={`absolute top-[20vh] lg:top-[15vh] right-[10vw] lg:right-[15vw] w-[80vw] lg:w-[40vw] h-[15vh] lg:h-[30vh z-50`}>
