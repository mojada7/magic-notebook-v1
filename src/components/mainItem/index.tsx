...
function MainItem({title, pic, hr, text} : any) {
  return (
    <Link href={`/${hr}`}>
      <div className='z-50 w-[85vw] border-[6px] hover:bg-sky-100 text-sky-400 hover:text-sky-500 bg-transparent border-y-pink-300 bg-white border-sky-400 outline-2 md:w-[40vw] lg:w-[25vw] mt-[1vh] lg:mt-[2vh] h-[22vh] lg:h-[30vh]  rounded-3xl font-bold text-center flex justify-center items-center hover:scale-105'>
