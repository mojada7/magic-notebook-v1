...
function Header() {
  return (
    <>
    <div className='border-b-[8px] lg:border-b-[16px] bg-sky-200 text-black border-yellow-400 z-50'>
      <div className='border-b-[8px] lg:border-b-[16px] border-pink-300'>
        <div className='w-full flex ps-2 lg:ps-5 pt-2 items-end h-[8vh] lg:h-[12vh] border-b-[8px] lg:border-b-[16px] border-sky-400 z-50'>
            ...
            <div className={`ps-2 lg:ps-4 text-2xl lg:text-4xl pb-2 lg:pb-0 text-black ${style.h3} ${style.font}`}>magic-noteBook</div>
        </div>
      </div>
    </div>
