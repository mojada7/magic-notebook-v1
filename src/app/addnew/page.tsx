    ...
    <>
      ...
      <div className='z-20 flex flex-col items-center justify-center pt-[10vh]'>
        ...
        <div className='flex mt-8 rounded-xl border-[6px] border-sky-200'>
          <input ref={eref} onChange={(e)=> eChangeHandler(e)} className='w-[20rem] lg:w-[24rem] h-[5rem] text-center  placeholder-pink-300 text-xl text-pink-400 border-sky-200 font-bold' placeholder='Type new English word here ...' />
        ...
        <div className='flex rounded-xl border-[6px] mt-4 border-sky-200'>
          <input ref={sref} onChange={(e)=> sChangeHandler(e)} className='w-[20rem] lg:w-[24rem] h-[5rem] text-center placeholder-sky-300 text-xl text-sky-400 font-bold' placeholder='Persian translation here ...' />
